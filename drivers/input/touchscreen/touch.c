...
int tp_util_get_vendor(struct hw_resource *hw_res, struct panel_info *panel_data)
{
	...
	prj_id = g_tp_prj_id;
	if ((prj_id == 20161 || prj_id == 20163 || prj_id == 20351 || prj_id == 20352) \
		&& strstr(saved_command_line, "mdss_dsi_oppo20135samsung_amb655xl08_1080_2400_cmd_2")) {
		pr_err("[TP] Jin use Hima/Yasuo/Chaka's S6SY792_SAMSUNG panel = TP_BOE! \n");
